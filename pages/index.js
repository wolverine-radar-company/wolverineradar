  ...
  <div className={`py-12 sm:py-16 text-white_txt `} >
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto max-w-2xl lg:text-center">
        ...
        <Image src={"/wolverineradar/images/MEBDABS_vd.jpg"} width={608} height={300} className='mx-auto mt-10' />
  ...
  <div className={`py-12 sm:py-16 text-white_txt `} >
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto max-w-2xl lg:text-center">
        ...
        <Image src={"/wolverineradar/images/satellite.jpeg"} width={608} height={300} className='mx-auto mt-10' />
      </div>
    </div>
  </div>
  ...
  <div className={`py-12 sm:py-16 text-white_txt `} >
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto max-w-2xl lg:text-center">
        ...
        <Image src={"/wolverineradar/images/earth.png"} width={664} height={350} className='mx-auto mt-10' />
  ...
  <div className={`py-12 sm:py-16 text-white_txt `} >
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto max-w-2xl lg:text-center">
        ...
        <Image src={"/wolverineradar/images/radarography.png"} width={608} height={300} className='mx-auto mt-10' style={{ backgroundColor: 'gray' }}/>
        </div>
