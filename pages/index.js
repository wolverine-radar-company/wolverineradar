...
export default function Home() {
  ...
  return (
    <div className='-ml-6 -mr-6'>
      ...
      <section id='mission' className="relative p-6 w-screen h-full -m-0 overflow-hidden mt-8">
      ...
      <section id='technology' className="relative p-6 w-screen h-full -m-0 overflow-hidden mb-8">
      ...
      <section id="technology" className="relative p-6 w-screen max-h-50 overflow-hidden mt-20 mb-8">
        <div className="flex justify-center items-center min-h-fit h-80 relative">
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 w-full h-full'>
          ...
          <div className="w-full h-full mx-auto p-6 rounded-lg overflow-hidden flex flex-col">
            <div className="mx-auto max-w-2xl lg:text-center p-4 w-1/2">
              <Image src={"/builders.jpg"} width={608} height={300}/>
              {/* <p className='-mt-6 text-white text-left ml-4 md:ml-10 text-[8px]'>Contains modified Copernicus Sentinel data 2023</p> */}
            </div>
          </div>
    ...
    <section id='accelerating' className="relative p-6 w-screen h-full -m-0 overflow-hidden">
        <div className='grid grid-cols-1 sm:grid-cols-2 w-full h-full mt-8'>
          ...
          <div className="w-full h-full mx-auto p-6 rounded-lg overflow-hidden flex flex-col">
            <div className="mx-auto max-w-2xl lg:text-center p-4 w-1/2">
              <Image src={"/users.jpg"} width={608} height={300}/>
              {/* <p className='-mt-6 text-white text-left ml-4 md:ml-10 text-[8px]'>Contains modified Copernicus Sentinel data 2023</p> */}
            </div>
          </div>
          {/* Left Side */}
    ...
    <section id='accelerating' className="relative p-6 w-screen h-full -m-0 overflow-hidden">
        <div className='grid grid-cols-1 sm:grid-cols-2 w-full h-full mt-8'>
          ...
          <div className="w-full h-full mx-auto p-6 rounded-lg overflow-hidden flex flex-col">
            <div className="mx-auto max-w-2xl lg:text-center p-4 w-1/2">
              <Image src={"/researchers.jpg"} width={608} height={300}/>
              {/* <p className='-mt-6 text-white text-left ml-4 md:ml-10 text-[8px]'>Contains modified Copernicus Sentinel data 2023</p> */}
            </div>
          </div>
    ...
    <section id='accelerating' className="relative p-6 w-screen h-full -m-0 overflow-hidden flex flex-col mb-20">
        <h1 className='text-white text-xl sm:text-2xl font-bold uppercase text-center'>Ready to see the world with new clarity?</h1>
        <div className='w-1/2 items-center text-center mx-auto mt-6'>
          <Link href="/contact" className="bg-white text-black px-4 py-2 rounded-md">Get in Touch</Link>
        </div>
</section>
